  ...
  return (
    <div className="py-3 px-10 sm:px-4 md:px-6 lg:px-6">
        <div className="container mx-auto py-[2vh]">
            <div className="text-2xl md:text-3xl font-bold text-center text-[#2e2e2e] lg:text-4xl">New <span className="text-[#f54748]">Foods</span></div>
            <div className="grid py-6 gap-8 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1">
                ...
                <div className="food-card bg-red-500/10  rounded-xl flex flex-col cursor-pointer items-center p-5">
                    <div className="relative mb-3">
                        <a href="/">
                            <img src="https://res.cloudinary.com/dvge54a7y/image/upload/v1704382343/hiv4ccdrsz3s1cz8rypg.png" className="h-64" alt="" />
                            <div className="absolute top-2 left-2">
                                <button className="shadow-sm text-white bg-red-500 hover:bg-red-700 cursor-pointer p-5 rounded-full relative">
                                  <FaHeart className=" absolute text-xl top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 "/>
                                </button>           
                    ...
                    <div className="flex gap-4 mb-3 items-center">
                        <p className="text-lg text-center font-bold text-[#f54748]">Domm Biryani</p>
                        <div className="flex text-sm space-x-2 cursor-pointer">
                            <span className=" font-normal text-[#fdc55e]">4.3</span>
                            <FaStar className="text-[#fdc55e]" height={16} width={16}/>
                        </div>
                ...
                <div className="food-card bg-red-500/10  rounded-xl flex flex-col cursor-pointer items-center p-5">
                    <div className="relative mb-3">
                        <a href="/">
                            <img src="https://res.cloudinary.com/dvge54a7y/image/upload/v1704382596/qlnxvay3y62ge8be4ky1.png" className="h-64" alt="" />
                            <div className="absolute top-2 left-2">
                                <button className="shadow-sm text-white bg-red-500 hover:bg-red-700 cursor-pointer p-5 rounded-full relative">
                                  <FaHeart className=" absolute text-xl top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 "/>
                                </button>           
                    ...
                    <div className="flex gap-4 mb-3 items-center">
                        <p className="text-lg text-center font-bold text-[#f54748]">Pineapple</p>
                        <div className="flex text-sm space-x-2 cursor-pointer">
                            <span className=" font-normal text-[#fdc55e]">4.3</span>
                            <FaStar className="text-[#fdc55e]" height={16} width={16}/>
                        </div>
                ...
                <div className="food-card bg-red-500/10  rounded-xl flex flex-col cursor-pointer items-center p-5">
                    <div className="relative mb-3">
                        <a href="/">
                            <img src="https://res.cloudinary.com/dvge54a7y/image/upload/v1704382516/b1lylr99wnutslxdhcos.png" className="h-64" alt="" />
                            <div className="absolute top-2 left-2">
                                <button className="shadow-sm text-white bg-red-500 hover:bg-red-700 cursor-pointer p-5 rounded-full relative">
                                  <FaHeart className=" absolute text-xl top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 "/>
                                </button>           
                    ...
                    <div className="flex gap-4 mb-3 items-center">
                        <p className="text-lg text-center font-bold text-[#f54748]">Strawberry</p>
                        <div className="flex text-sm space-x-2 cursor-pointer">
                            <span className=" font-normal text-[#fdc55e]">4.3</span>
                            <FaStar className="text-[#fdc55e]" height={16} width={16}/>
                        </div>
                ...
                <div className="food-card bg-red-500/10  rounded-xl flex flex-col cursor-pointer items-center p-5">
                    ...
                    <div className="flex gap-4 mb-3 items-center">
                        <p className="text-lg text-center font-bold text-[#f54748]">Handi Biryani</p>
                        <div className="flex text-sm space-x-2 cursor-pointer">
                            <span className=" font-normal text-[#fdc55e]">4.3</span>
                            <FaStar className="text-[#fdc55e]" height={16} width={16}/>
                        </div>
